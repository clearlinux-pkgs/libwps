...
Source0  : https://dev-www.libreoffice.org/src/libwps-0.4.12.tar.xz
...
%prep
%setup -q -n libwps-0.4.12
cd %{_builddir}/libwps-0.4.12
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1650911403
...
cp %{_builddir}/libwps-0.4.12/COPYING.LGPL %{buildroot}/usr/share/package-licenses/libwps/3704f4680301a60004b20f94e0b5b8c7ff1484a9
cp %{_builddir}/libwps-0.4.12/COPYING.MPL %{buildroot}/usr/share/package-licenses/libwps/9744cedce099f727b327cd9913a1fdc58a7f5599
%make_install
