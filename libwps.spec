...
# autospec commit: 9e256df
#
Name     : libwps
Version  : 0.4.14
Release  : 7
URL      : https://dev-www.libreoffice.org/src/libwps-0.4.14.tar.xz
Source0  : https://dev-www.libreoffice.org/src/libwps-0.4.14.tar.xz
...
%prep
%setup -q -n libwps-0.4.14
cd %{_builddir}/libwps-0.4.14
pushd ..
cp -a libwps-0.4.14 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726103007
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libwps-0.4.so.4.0.14
/usr/lib64/libwps-0.4.so.4
/usr/lib64/libwps-0.4.so.4.0.14
